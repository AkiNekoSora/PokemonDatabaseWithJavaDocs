...
public class AddFilePage extends JFrame {
    ...
    /**
     * Opens the dialogue box for the user to select, calls the addPokemonFromFileGUI method in
     * the pokemonManager (goes through the lines of the file and adds the Pokémon to the list,
     * returns an error message if failed, and the line number), if any errors occur it shows the
     * error on the screen, if successful it goes to the AddFileSuccessPage.
     * @param mainApp MainMenuPage Gui main menu
     */
    ...
    /**
     * Returns the text for how to format the .txt file.
     * @return String with the correct .txt format
     */
