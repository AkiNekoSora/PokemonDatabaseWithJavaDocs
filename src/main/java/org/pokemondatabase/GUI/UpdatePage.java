...
public class UpdatePage extends JFrame {
     ...
     * @param updatedPokemon Pokémon needing to be updated
    ...
    /**
     * Hides all errors everytime the user attempts to enter information again
     */
    ...
    /**
     * Obtains all entered information, checks for any errors, and returns errors or moves to the
     * success page.
     * @param mainApp MainMenuPage Gui main menu
     * @param updatedPokemon Pokémon needing to be updated
     */
