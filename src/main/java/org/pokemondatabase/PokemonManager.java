...
/**
 * <p>Used for all the methods that interact with the Pokémon Class. Uses the userInputHelper
 * class to loop until the user gives a valid input. Uses Text class to color the output to look
 * nicer in the CLI
 ...
 * add it to the Pokémon Storage.</li>
 * <li>Add a Pokémon using a txt file.</li>
 * <li>Remove a Pokémon using a Pokédex Number.</li>
 * <li>Find a Pokémon using a Pokédex Number.</li>
 * <li>Get all Pokémon and prints them to the CMI.</li>
 * <li>Update a Pokémon using a Pokédex Number.</li>
 * <li>Compare the weight and height of 2 Pokémon</li>
 * <li>Check when a specified Pokémon will evolve.</li>
 * </ul>
 */
public class PokemonManager {
    ...
    /**
     * Used to bring the userInputHelper and Text classes into scope.
     */
    ...
    /**
     * Overloaded constructor only used by the tests.
     * @param userInputHelper used to bring the UserInputHelper into scope
     */
    ...
    /**
     * Lets the user add a Pokémon using the CMI. Calls other methods in this class to obtain all
     * Pokémon information using the CLI.
     * @param pokemonStorage List of Pokémon
     * @param mainApp MainMenuPage Gui main menu
     * @return String Success or Failure results
     */
    ...
    /**
     * Calls the userInputHelper method to ask the user to enter a Pokémon Name.
     * @return String the Pokémon
     */
    ...
    /**
     * Calls the userInputHelper method getIntInRange with the parameters 1 and 1164 to get the
     * new Pokédex numbr with specified parameters.
     * @param mainApp MainMenuPage Gui main menu
     * @return int of Pokédex Number
     */
    ...
    /**
     * Checks through the list of Pokémon to verify the provided Pokédex Number does not match a
     * Pokédex number already in the system.
     * @param pokedexNumber int Pokédex Number
     * @param mainApp MainMenuPage Gui main menu
     * @return ValidationResults containing a boolean whether it passed, and a String of the results
     */
    ...
    /**
     * Calls the userInputHelper method getValidType for the primary type and a secondary type if
     * the user chooses to add one.
     * @return PokémonTypesManager containing the Primary and possibly Secondary Types.
     */
    ...
    /**
     * Calls the userInputHelper method getBooleanInput to check if the Pokémon has a next
     * evolution and then uses the getIntInRange method to get a valid Pokémon Level.
     * @return Int of the Next Evolution Level
     */
    ...
    /**
     * Uses the userInputHelper method getBigDecimal to get either the height or weight
     * @param weightOrHeight String containing the Weight or Height
     * @return BigDecimal of either the weight or height of a Pokémon
     */
    ...
    /**
     * Calls userInputHelper method getBooleanInput to get true or false from the user.
     * @return Boolean of if the Pokémon has been caught or not.
     */
    ...
    /**
     * Calls userInputHelper method getBooleanInput to ask the user if they want to add a Pokédex
     * Entry and then the getString method to get the Pokédex Entry.
     * @return String of the Pokédex Entry (can be null)
     */
    ...
    /**
     * Allows the user to specify a file location and add all Pokémon in that file to the system.
     * Then looks through the lines calling the getPokémon Method
     * @param fileLocation String of the File Path
     * @param mainApp MainMenuPage Gui main menu
     * @return Validation Results (boolean, String)
     */
    ...
    /**
     * Called by addPokémonFromFile method. Used to take a String list and split it into the
     * specified variables and create a new Pokémon with it.
     * @param variables A List of Strings from each line of the text document
     * @param lineCounter the counter used to check what current line the system is on
     * @param mainApp MainMenuPage Gui main menu
     * @return ValidationResults(Boolean, String)
     */
     ...
     * Allows the user to specify a file location and add all Pokémon in that file to the system.
     * Then looks through the lines calling the getPokémon Method
     * @param pokemonStorage The List that holds all Pokémon
     * @param mainApp MainMenuPage Gui main menu
     * @return String of the error message or the success message
     */
    ...
    /**
     * Used to accept a Pokédex Number to specify a Pokémon to change specified piece
     * of information. Then uses a switch to update a single piece of information.
     * @param pokemonStorage List of Pokémon
     * @param mainApp MainMenuPage Gui main menu
    ...
    /**
     * Allows a user to remove a Pokémon using a Pokédex Number
     * @param pokemonStorage The List that holds all Pokémon
     * @return String Of the Results
     */
    ...
    /**
     * Allows the user to search for a Pokémon using the Pokédex ID
     * @param pokemonStorage The List that holds all Pokémon
    ...
    /**
     * Allows the user to specify 2 Pokémon and compare their heights and weights.
     * @param pokemonStorage The List that holds all Pokémon
     * @return String With the Results
     */
    ...
    /**
     * Allows the user to specify a Pokédex Number and a current level and then states if the
     * Pokémon has reached its max evolution or how many levels until it will evolve.
     * @param pokemonStorage The List that holds all Pokémon
     * @return String with the results
     */
    ...
    /**
     * Used to print the list of Pokémon provided
     * @param pokemonStorage List of Pokémon
     * @return String of the original message colored Magenta
     */
    ...
    /**
     * Used to change the color of any success messages or results.
     * @param successMessage String containing a success message
     * @return String of the original message colored Magenta
     */
